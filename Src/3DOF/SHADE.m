function SHADE(inputData)
% SHADE  Success-History Based Adaptive Differential Evolution for 24-parameter longitudinal model identification.
% Estimates aircraft stability and multi-control derivatives with historical memory parameter adaptation.
...
% SHADE hyperparameter memory
memorySize = 200;
F = rand(populationSize, 1);
CR = rand(populationSize, 1);
archive = [];
...
save("SHADE-New-LongAlgoData.mat");
