function MFO6DOF(inputData)
% MFO6DOF  Moth-Flame Optimization for 6-DOF aircraft parameter identification (60 derivatives).
...
for iter = 1:maxIterations
    ...
    if iter > 1 && abs(globalrmse(iter) - globalrmse(iter - 1)) < 0.0001
        disp("MFO6DOF: convergence criterion reached");
        break;
    end

    % Logarithmic spiral update around flame positions
