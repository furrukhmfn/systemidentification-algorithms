function CMAES6DOF(inputData)
% CMAES6DOF  Evolutionary search for 6-DOF aircraft parameter identification (60 derivatives).
...
for iter = 1:maxIterations
    ...
    if iter > 1 && abs(globalrmse(iter) - globalrmse(iter - 1)) < 0.0001
        disp("CMAES6DOF: convergence criterion reached");
        break;
    end

    % Spiral trajectory update around sorted elite solutions
